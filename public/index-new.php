...
<head>
    ...
    <link rel="stylesheet" href="fonts/font-awesom.css" />
    <link rel="stylesheet" href="css/index.css">
    <script src="https://cdn.bootcdn.net/ajax/libs/jquery/3.5.1/jquery.js"></script>
</head>

<?php
    //check login status & get the username
...
<body>
    ...
    <div class="js-cartmask"></div>
    <div id="CartDrawer" class="drawer drawer-right">
        <div class="drawer__header flex-box">
            <div class="flex-item">
                <h3>My Cart</h3>
            </div>
            <div class="flex-item text-right">
                <span class="inline_close js-close-drawer">Close</span>
            </div>
        </div>
    ...
    <div class="shifter-navigation">
        <div class="search">
            <form action="/search" method="GET">
                <input id="q" type="text" placeholder="SEARCH"></input>
            </form>
        </div>
        <ul id="accordion">
            <li>
                <a href="https://fitkyt.com">HOME</a>
            </li>
            <li>
                <a href="https://fitkyt.com/collections/all">Our Product Range</a>
            </li>
            <li>
                <a href="https://fitkyt.com/blogs/a-little-about-us/a-little-about-us">ABOUT US</a>
            </li>
            <li>
    ...
    <div class="is-moved-by-drawer">
        <header>
            <div class="head_cont row">
                <div class="destop-4 logo_cont default-m tablet-6 logo_cont-push">
                    <a href="#" class="logo"><img src="img/logo_max.jpg"></a>
                </div>
                <div class="destop destop-4 mo-3 tablet-6 default-m">
                    <ul id="cart" class="default-m tablet-3">
                        <li>
                        ...
                        <li class="shifter-handle"><i class="fa fa-bars"></i></li>
                        <!-- 更新 end-->
                    </ul>
                    <ul id="socilas" class="default-m tablet-3">
                        <li>
                            <a href="https://www.facebook.com/fitkyt"><i class="fa fa-facebook fa-2x"></i></a>
                        </li>
                        <li>
                            <a href="https://www.pinterest.com.au/fitkyt/"><i class="fa fa-pinterest fa-2x"></i></a>
                        </li>
                        <li>
                            <a href="https://instagram.com/fitkyt"><i class="fa fa-instagram fa-2x"></i></a>
                        </li>
                        <li class="searchBox">
                            <form action="/search" method="get">
                                <input type="test" id="q" placeholder="SEARCH" />
                            </form>
                        </li>
                    </ul>
                </div>
        ...
        <nav id="nav" class="nav-menu">
            <div id="navigat" class="row">
                <ul id="navig" class="destop-8 default-m">
                    <li>
                        <a href="https://fitkyt.com">HOME</a>
                    </li>
                    <li>
            ...
            <div class="row">
                <div class="default-m foot-sect destop-6 mo-3">
                    ...
                    <ul>
                        ...
                        <li>
                            <a href="https://fitkyt.com/pages/environmental-and-sustainability-commitment"
                                title>Environment & Sustainability Commitment</a>
                        </li>
                    </ul>
                </div>
                <div class="default-m foot-sect destop-6">
                    ...
                    <p>We do daily exercise so that we have the stamina, strength and resilience to get through
                        life.&nbsp;We need
                        to. &nbsp; We are relied upon by those we love.</p>
                    <p>Our products provide that little extra daily motivation and inspiration to help you get up and
                        move,
                        to
                        push that little harder. &nbsp;&nbsp; </p>
                    <p>Whatever it takes, don’t give up, one day at a time, through incremental change, good things will
                        happen.
                    </p>
                </div>
            </div>
            <div class="footer_bottom row sub-footer flex-box">
                ...
                <div class="footer-right">
                    <div>
                        ...
                        <svg class="payment-icon" version="1.1" xmlns="http://www.w3.org/2000/svg" role="img" x="0"
                        ...
                        <svg class="payment-icon" xmlns="http://www.w3.org/2000/svg" role="img" viewBox="0 0 38 24"
                            width="38" height="24" aria-labelledby="pi-discover">
                        ...
                        <svg class="payment-icon" width="38" height="24" role="img" aria-labelledby="pi-jcb"
        ...
        <script>
            $("#purchaseSub").click(function () {
                location.href = "chooseType/chooseType.html"
            })
            $("#purchaseOwn").click(function () {
                location.href = "chooseOwn/#"
            })
        </script> -->
</body>
